...
<p class="hero-desc">基于 Rust 原生库，为 Unity 提供安全、高效、异步的图片与音频加载能力，让资源管理不再拖慢你的项目。</p>
...
<span class="badge">:material-tag-outline: v0.2.0-rc8</span>
...
`UnityWebRequest` 和 `WWW` 在主线程造成卡顿，复杂资源解码耗时严重。

</div>
</div>

<div class="pain-card" markdown>
<div class="pain-icon" markdown>:material-delete:</div>
<div markdown>
...
<div class="step-desc" markdown>完全异步的 C# API 层，提供 `ImageAsset`、`AudioAsset` 等高级抽象，与 Unity 生态无缝集成。</div>
</div>
